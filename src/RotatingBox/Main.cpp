...
int main() {
  ...
  BasicModel3D boxModel(boxData3D, DrawingPipeline{ boxProgram }, TextureSet{ boxTexture });
  ...
  std::vector<WorldObject3D> objects {
    ...
    WorldObject3D(boxModel, Matrix4(Transform3(Matrix3::scale(Vector3(0.2, 0.2, 0.2)), Vector3(0.5f, 0.5f, -0.5f)))),
